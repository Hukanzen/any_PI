...
Public Class Show_Dot_Graph
	...
	'
	Public Sub graph_init(def_x_min As Double, def_x_max As Double, def_y_min As Double, def_y_max As Double, scale_x As Double, scale_y As Double)
		...
		Dim x As Double, y
		For x = def_x.min To def_x.max Step scale_x
		...
		For y = def_y.min To def_y.max Step scale_y
		...
		g_graph.DrawString("PI", font, Brushes.Red, 0, j)
